    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints:
            const BoxConstraints(minHeight: 48, maxHeight: 48, minWidth: 50),
        border: OutlineInputBorder(
          borderRadius:
              BorderRadius.circular(widget.radius ?? 14.r), // Rounded corners
          borderSide: BorderSide(
            color: widget.borderColor ?? Color(0xff1E293B), // Border color
