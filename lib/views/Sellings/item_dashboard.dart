...
class _ItemDashBoardState extends State<ItemDashBoard> {
  ...
  void initState() {
    ...
    if (product?.productType == 'auction' &&
        endTimeReached(product?.auctionEndingDate ?? '',
                product?.auctionEndingTime ?? '') ==
            false) {
      restrictEdit = true;
  ...
  updateProductDetail() async {
    if (product?.id != null) {
      product = await Provider.of<ProductViewModel>(context, listen: false)
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  ...
                  child: customListview(
                      img: (product?.photo?.isNotEmpty ?? false)
                          ? product!.photo![0].url!
                          : '',
                      title: product?.title ?? '',
                      ...
                      onTap: () {
                        if (restrictEdit == false) {
                          ...
                          showSnackBar(context,
                              'You cannot edit this product until the auction has ended.');
                        }
                      },
                      child: customContainer(
                    ...
                    InkWell(
                      onTap: () {
                        if (restrictMarkSold == false) {
                          ...
                          showSnackBar(context,
                              'You cannot mark this as sold until the auction has ended.');
                        }
                      },
                      child: customContainer(
                          img: "assets/images/markSold.png", txt: "Mark Sold"),
                    ),
                    InkWell(
                      onTap: () {
                        push(
              ...
              Padding(
                ...
                child: AppText.appText('Messages',
  ...
  bool endTimeReached(String endDate, String endTimeString) {
    DateTime? endTime = convertEndTimeToUserTimeZone(
        _parseEndingDateTime(endDate, endTimeString));
  ...
  DateTime _parseEndingDateTime(String endDate, String endTime) {
    ...
    DateTime endingDate = DateFormat("yyyy-MM-dd").parse(endDate);
    DateTime endingTime;
