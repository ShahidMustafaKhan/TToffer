                  ...
                  Consumer<SuggestionViewModel>(
                    builder: (context, suggestionViewModel, child) {
                      if (suggestionViewModel.suggestionList.isNotEmpty &&
                          suggestionViewModel.hideSuggestions == false &&
                          suggestionViewModel
                        ...
                        return Container(
                          ...
                          child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount:
                                suggestionViewModel.suggestionList.length > 7
                                    ? 7
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                title: Text(
                                  suggestionViewModel.suggestionList[index]
                                          ['title'] ??
                                      '',
                                ...
                                onTap: () async {
                                  ...
                                  suggestionViewModel.setSearchText(
                                      suggestionViewModel.suggestionList[index]
                                              ['title'] ??
                                          '');
                                  suggestionViewModel.emptySuggestionList(
                                      notify: true);
                                  await productViewModel.searchAllProducts(
                                      search: suggestionViewModel.searchText);
                                  suggestionViewModel.emptySuggestionList(
                                      notify: true);
                                },
                              );
                  ...
                  child: CustomAppFormField(
                    onChanged: (value) {
                      ...
                      if (value.isEmpty) {
                        ...
                        Provider.of<ProductViewModel>(context, listen: false)
                            .setSearchProduct(ApiResponse.notStarted());
  ...
  void _onTextChanged(String value, BuildContext context,
    ...
    suggestionViewModel.debounce = Timer(const Duration(milliseconds: 500), () {
      if (value != suggestionViewModel.lastTypedValue) {
        ...
        if (suggestionViewModel.lastTypedValue.isNotEmpty &&
            suggestionViewModel.lastTypedValue.length >= 3) {
          suggestionViewModel.searchSuggestion(
              suggestionViewModel.lastTypedValue, context);
        }
      }
    });
  }
