...
import '../../../All Categories/all_caetgories.dart';
            ...
            return Column(
              children: [
                ...
                SizedBox(
                  ...
                  width: screenWidth,
                  child:
                  categoryProvider.categoryList.status == Status.loading ?
                    Center(child: CircularProgressIndicator(color: AppTheme.yellowColor,)) :
                  ListView.builder(
                    padding: EdgeInsets.only(right: 5.w),
                    scrollDirection: Axis.horizontal,
                    itemCount: categoryProvider.categoryList.data?.isNotEmpty ?? false ? 6 : 0,
                    itemBuilder: (context, index) {

                      List<CategoryModel> categoryList = categoryProvider.categoryList.data ?? [];
