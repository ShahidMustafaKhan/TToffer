...
class _ViewAllAuctionProductsState extends State<ViewAllAuctionProducts> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                            child: lableFields(
                                controller: minPrice, hintText: 'Min Price')),
                        const SizedBox(
                          width: 10,
                        ),
                        Expanded(
                            child: lableFields(
                                controller: highPrice, hintText: 'High Price'))
                      ],
                    ),
  ...
  void _showTooltip() {
    ...
    final tooltipWidth = size.width;
    final tooltipHeight = size.height;

    overlayEntry?.remove();
    overlayEntry = OverlayEntry(
      builder: (context) => Positioned(
        left: offset.dx - tooltipWidth / 2 + 15,
        // Adjust position as needed
        top: offset.dy - tooltipHeight - 12,
        child: Material(
          color: Colors.transparent,
          child: Container(
